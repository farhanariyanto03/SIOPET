...
public class panel_layanan extends javax.swing.JPanel {
    ...
    public panel_layanan() {
        ...
        ScrollPaneKeranjang2.setVerticalScrollBar(new ScrollBarCustom());
    ...
    public void getCardGrommingKucing(){
        try {
            ...
            while(res.next()){
                ...
                @Override
                public void mouseClicked(MouseEvent e) {
                    form_transaksiGromming1 transgrom = new form_transaksiGromming1();
                    super.mouseClicked(e);
                    nomorPanel = id_gromming;
                    if (klikEdit) {
                        CRUD_Layanan.klik_edit_gromming(id_gromming, jenis_hewan);
                    }else{
                        try {
                        String sql = "INSERT INTO tb_keranjang (id_barang, nama_barang, harga_barang, jumlah) VALUES (?, ?, ?, ?)";
                              ...
                              java.sql.PreparedStatement pst=conn.prepareStatement(sql);
                                  ...
                                  pst.setString(1, id_gromming); 
                                  pst.setString(2, nama_gromming); 
                                  pst.setString(3, harga_gromming); 
                                  pst.setString(4, "1"); 
                                  pst.execute();
        ...
        try {
            ...
            while(res.next()){
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    if (klikEdit) {
                        CRUD_Layanan.klik_edit_penitipan(id_penitipan, jenis_hewan);
                    }else{
                        try {
                        String sql = "INSERT INTO tb_keranjang (id_barang, nama_barang, harga_barang, jumlah) VALUES (?, ?, ?, ?)";
                              java.sql.Connection conn=(Connection)config.configDB();
                              java.sql.PreparedStatement pst=conn.prepareStatement(sql);
                                  ...
                                  pst.setString(1, id_penitipan); 
                                  pst.setString(2, nama_penitipan); 
                                  pst.setString(3, harga_penitipan); 
                                  pst.setString(4, "1"); 
                                  pst.execute();
...
//    }
    ...
    private void initComponents() {
        ...
        btn_lanjut1 = new javax.swing.JLabel();
        ScrollPaneKeranjang = new javax.swing.JScrollPane();
        btn_close_keranjang = new javax.swing.JLabel();
        bg_card1 = new javax.swing.JLabel();
        keranjang2 = new javax.swing.JPanel();
        btn_close_keranjang2 = new javax.swing.JLabel();
        btn_lanjut2 = new javax.swing.JLabel();
        ScrollPaneKeranjang2 = new javax.swing.JScrollPane();
        ...
        keranjang.setBackground(new Color(0,0,0,150));
        keranjang.setLayout(null);

        btn_lanjut1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_lanjut1MouseClicked(evt);
            }
        });
        keranjang.add(btn_lanjut1);
        btn_lanjut1.setBounds(800, 840, 170, 40);

        ScrollPaneKeranjang.setBackground(new Color(0,0,0,0));
        keranjang.add(ScrollPaneKeranjang);
        ScrollPaneKeranjang.setBounds(640, 340, 490, 500);

        btn_close_keranjang.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_close_keranjangMouseClicked(evt);
            }
        });
        keranjang.add(btn_close_keranjang);
        btn_close_keranjang.setBounds(1070, 280, 41, 50);

        bg_card1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/keranjang layanan.png"))); // NOI18N
        bg_card1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                bg_card1MouseClicked(evt);
            }
        });
        keranjang.add(bg_card1);
        bg_card1.setBounds(640, 270, 490, 640);

        add(keranjang);
        keranjang.setBounds(0, 0, 1920, 1080);

        keranjang2.setBackground(new Color(0,0,0,0));
        keranjang2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                keranjang2MouseEntered(evt);
            }
        });
        keranjang2.setLayout(null);

        btn_close_keranjang2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_close_keranjang2MouseClicked(evt);
            }
        });
        keranjang2.add(btn_close_keranjang2);
        btn_close_keranjang2.setBounds(430, 10, 41, 50);

        btn_lanjut2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_lanjut2MouseClicked(evt);
            }
        });
        keranjang2.add(btn_lanjut2);
        btn_lanjut2.setBounds(160, 570, 170, 40);

        ScrollPaneKeranjang2.setBackground(new Color(0,0,0,0));
        keranjang2.add(ScrollPaneKeranjang2);
        ScrollPaneKeranjang2.setBounds(0, 70, 490, 500);

        bg_card.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/keranjang layanan.png"))); // NOI18N
        keranjang2.add(bg_card);
        bg_card.setBounds(0, 0, 490, 640);

        add(keranjang2);
        keranjang2.setBounds(760, 220, 490, 640);
        ...
        add_jumlah.setBackground(new Color(0,0,0,150));
        ...
        bg1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/layanan - barang (1).png"))); // NOI18N
        ...
        tf_edit_hargapenitipan.setBounds(950, 510, 270, 40);
        ...
        tf_edit_idpenitipan.setBounds(620, 420, 280, 40);
        ...
        tf_edit_namapenitipan.setBounds(950, 420, 270, 40);
        ...
        cmb_editpenitipan_jenishewan.setBounds(620, 510, 280, 40);
        ...
        tf_editpenitipan_keterangan1.setBounds(620, 600, 280, 40);
        ...
        tf_editpenitipan_keterangan2.setBounds(950, 600, 270, 40);
        ...
        tf_editpenitipan_keterangan3.setBounds(620, 690, 280, 40);
        ...
        tf_editpenitipan_keterangan4.setBounds(950, 690, 270, 40);
        ...
        btn_simpan_penitipan.setBounds(850, 790, 150, 40);
        ...
        btn_close4.setBounds(1270, 310, 50, 50);
        ...
        bg_inputbarang4.setBounds(510, 300, 826, 570);
        ...
        tf_inputpenitipan_keterangan4.setBounds(990, 680, 270, 40);
        ...
        tf_inputpenitipan_keterangan3.setBounds(660, 680, 270, 40);
        ...
        tf_inputpenitipan_keterangan2.setBounds(990, 590, 270, 40);
        ...
        tf_inputpenitipan_keterangan1.setBounds(660, 590, 270, 40);
        ...
        tf_input_hargapenitipan.setBounds(990, 510, 270, 40);
        ...
        tf_input_idpenitipan.setBounds(660, 410, 280, 40);
        ...
        tf_input_namapenitipan.setBounds(990, 410, 270, 40);
        ...
        cmb_inputpenitipan_jenishewan.setBounds(660, 510, 270, 40);
        ...
        btn_close5.setBounds(1310, 300, 40, 50);
        ...
        btn_tambah_penitipan.setBounds(880, 780, 160, 40);
        ...
        bg_inputbarang5.setBounds(550, 290, 826, 570);
        ...
        bg2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/layanan - penitipan - anjing.png"))); // NOI18N
        ...
        layanan_gromming.add(btn_tambah);
        btn_tambah.setBounds(1816, 132, 60, 60);
        ...
        layanan_gromming.add(btn_edit);
        btn_edit.setBounds(1734, 132, 60, 60);
        ...
        layanan_gromming.add(btn_delete);
        btn_delete.setBounds(1650, 130, 60, 60);
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/layanan - gromming - anjing.png"))); // NOI18N
    ...
    private void btn_deleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_deleteMouseClicked
        if (nomorPanel != null) {
            try{
                String resultSet = "DELETE FROM tb_barang WHERE id_barang ='"+ nomorPanel +"'";
    ...
    private void btn_tambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_tambahMouseClicked
        input_gromming.setVisible(true);
        //this.setComponentZOrder(input_gromming, 0);
...
//        }
    ...
    private void keranjang2MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_keranjang2MouseEntered
        keranjang2.setVisible(true);
    }//GEN-LAST:event_keranjang2MouseEntered
    ...
    private void btn_lanjut2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_lanjut2MouseClicked
        try {
          String sql = "INSERT INTO tb_keranjang (id_barang, nama_barang, harga_barang, jumlah) VALUES (?, ?, ?, ?)";
                java.sql.Connection conn=(Connection)config.configDB();
                java.sql.PreparedStatement pst=conn.prepareStatement(sql);
    ...
    }//GEN-LAST:event_btn_lanjut2MouseClicked
    ...
    private void btn_close_keranjang2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_close_keranjang2MouseClicked
        keranjang2.setVisible(false);
    }//GEN-LAST:event_btn_close_keranjang2MouseClicked

    private void btn_close_keranjangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_close_keranjangMouseClicked
        keranjang.setVisible(false);
    }//GEN-LAST:event_btn_close_keranjangMouseClicked

    private void btn_lanjut1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_lanjut1MouseClicked
        try {
          String sql = "INSERT INTO tb_keranjang (id_barang, nama_barang, harga_barang, jumlah) VALUES (?, ?, ?, ?)";
                java.sql.Connection conn=(Connection)config.configDB();
                java.sql.PreparedStatement pst=conn.prepareStatement(sql);
    ...
    }//GEN-LAST:event_btn_lanjut1MouseClicked

    private void bg_card1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bg_card1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_bg_card1MouseClicked
    ...
    private javax.swing.JScrollPane ScrollPaneKeranjang2;
    ...
    private javax.swing.JLabel bg_card1;
    ...
    private javax.swing.JLabel btn_close_keranjang;
    private javax.swing.JLabel btn_close_keranjang2;
    ...
    private javax.swing.JLabel btn_lanjut1;
    private javax.swing.JLabel btn_lanjut2;
    ...
    private javax.swing.JPanel keranjang2;
