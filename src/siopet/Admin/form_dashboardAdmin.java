...
//                    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        setExtendedState(form_dashboardAdmin.MAXIMIZED_BOTH);
...
//        lbl_formDashboard.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hover/Nav-Beranda.png")));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_dashboardAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
