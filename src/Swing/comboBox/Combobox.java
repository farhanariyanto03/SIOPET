...
public class Combobox <e> extends JComboBox <e> {
    ...
    public String getLabeTaxt() {
        return labeTaxt;
    }

    public void setLabeTaxt(String labelText) {
        this.labeTaxt = labelText;
    }
    ...
    private class ComboUI extends BasicComboBoxUI {
        ...
        @Override
        public void paintCurrentValueBackground(Graphics grphcs, Rectangle rct, boolean bln) {
        ...
        private void createHintText(Graphics2D g2){
            ...
            Rectangle2D r2 = ft.getStringBounds(combo.getLabeTaxt(), g2);
            ...
            g2.drawString(combo.getLabeTaxt(), in.right, (int) (in.top + textY + ft.getAscent() - size));
        }
